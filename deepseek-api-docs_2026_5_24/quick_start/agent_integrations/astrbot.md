...
- [](/zh-cn/)- 快速开始- 接入 Agent 工具- AstrBot
本页总览
...
#### 1. 安装 AstrBot[​](#1-安装-astrbot)


##### 通过 uv 安装 AstrBot[​](#通过-uv-安装-astrbot)
...
##### 通过 Docker 安装 AstrBot[​](#通过-docker-安装-astrbot)
...
#### 2. 配置 AstrBot 中的默认模型[​](#2-配置-astrbot-中的默认模型)

初始化完成后，打开 Web UI：


```
http://localhost:6185 # 如果 AstrBot 运行在服务器上，则访问 http://:6185
```

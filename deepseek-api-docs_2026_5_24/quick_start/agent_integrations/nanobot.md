...
- [](/zh-cn/)- 快速开始- 接入 Agent 工具- nanobot
本页总览
...
#### 2. 配置 nanobot 的配置文件[​](#2-配置-nanobot-的配置文件)
...
```
{    "agents": {        "defaults": {            "model": "deepseek-v4-pro",            "provider": "deepseek",        }    },    "providers": {        "deepseek": {            "apiKey": "",            "apiBase": "https://api.deepseek.com/v1",        },    },}
```

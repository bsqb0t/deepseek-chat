...
- [](/zh-cn/)- 快速开始- 接入 Agent 工具- Deep Code
本页总览
...
#### 3. 进入项目目录并启动 Deep Code[​](#3-进入项目目录并启动-deep-code)
...
#### 使用 Agent Skills[​](#使用-agent-skills)
